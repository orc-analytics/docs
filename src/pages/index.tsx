...
const description = "Orca Telemtry: Bolt-on analytics for robotics and autonomous systems. Turn existing telemetry streams into production AI models with compile-time reliability."
